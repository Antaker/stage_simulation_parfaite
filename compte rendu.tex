...
\begin{proof}
Notons par $V^{(n)}[1]$ le volume la boule unité de dimension $n$ et de rayon $1$. On a d'abord $V^{(1)}[1] = 2$, puis pour tout $n \geq 1$, on a par récurrence, en utilisant le théorème de Fubini :
